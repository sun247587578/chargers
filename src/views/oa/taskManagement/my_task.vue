      ...
      <el-form ref="form" :model="form" label-width="150px">
        ...
        <table style="width:100%">
          <tr>
            <td>
              <el-form-item label="任务名称">
                <el-input v-model="form.commTask.taskName" auto-complete="off"></el-input>
              </el-form-item>
            </td>
            <td>
              <el-form-item label="负责人">
                <el-select v-model="form.commTask.taskLeaderId" placeholder="请选择指标类别" filterable style="width:100%">
          ...
          <tr>
            <td style="width:50%">
              <el-form-item label="到期日">
                <el-date-picker v-model="form.dateString" type="datetime" placeholder="选择结束时间" @change="sfomartData2" style="width:100%">
                </el-date-picker>
              </el-form-item>
            </td>
            <td style="width:50%">
              <el-form-item label="紧急程度">
                <el-radio-group v-model="form.commTask.taskUrgentLevel">
        ...
        <el-form-item label="参与人员">
          <el-select v-model="form.joinPersonIds" placeholder="请选择指标类别" multiple filterable style="width:100%">
            <el-option v-for="item in userList" :key="item.id" :label="item.userName" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="进度">
          <div>
            ...
            <el-slider v-model="form.commTask.taskCptPercent" show-input :step="10"></el-slider>
          </div>
        </el-form-item>
        <el-form-item label="任务详情">
          <vue-editor v-model="form.commTask.taskContent" :editorToolbar="customToolbar"></vue-editor>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      updataMyTask(this.form).then(res => {
        console.log(res)
        if (res.httpCode == 200) {
          this.$message({
            type: 'success',
    ...
    lookDetil(index) {
      // this.form = $.extend(true, newObj, this.formcus);this.dataList[index];
      let newObj = new Object();
      $.extend(true, newObj, this.dataList[index]);
      // this.form = newObj;
      console.log(newObj)
      this.form.commTask.taskName = newObj.taskName;
      this.form.commTask.taskLeaderId = newObj.taskLeaderId;
      this.form.commTask.taskContent = newObj.taskContent;
      this.form.commTask.taskUrgentLevel = newObj.taskUrgentLevel;
      this.form.commTask.taskCptPercent = Number(newObj.taskCptPercent);
      this.form.dateString = newObj.taskEndDate;
      this.joinPersonIds = newObj.joinPersonIds;
     /* form: {
