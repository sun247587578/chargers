    ...
    <div class="register">
        <div class="container-fixed" style="padding-top:50px">
            ...
            <div class="center-block register-form" style="width:600px">
                <el-form ref="form" :model="form" label-width="100px" v-if='registerNext'>
                ...
                <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" v-else>
...
export default {
    ...
    methods: {
        submitForm(formName) {
            if(this.ruleForm2.unitName==''||this.ruleForm2.userName==''|| this.ruleForm2.password==''){
                this.$message({
                    type: 'error',
                    message: '请完善信息'
                });
        ...
        interval() {
            ...
            var intervalVerfication = setInterval(v => {
                keepTime--;
