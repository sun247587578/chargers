    ...
    <el-row>
      <el-col :span="24">
        <el-form :inline="true" :model="search" class="demo-form-inline">
          ...
          <el-form-item lable="时间段">
            <el-date-picker v-model="search.beginTime" type="date" placeholder="开始时间" style="width:100%" @change="searchfomartData1"></el-date-picker>
          </el-form-item>
          <el-form-item>
            <el-date-picker v-model="search.endTime" type="date" placeholder="结束时间" style="width:100%" @change="searchfomartData2"></el-date-picker>
          </el-form-item>
          <el-form-item>
