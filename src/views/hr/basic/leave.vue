    ...
    <el-row>
      <el-col :span="24">
        <el-form :inline="true" :model="search" class="demo-form-inline">
          <el-form-item>
              <el-date-picker v-model="search.beginDate" format="yyyy-MM-dd" type="datetime" @change="sfomartData" placeholder="选择开始时间">
              </el-date-picker>
              <el-date-picker v-model="search.endDate" type="datetime" placeholder="选择结束时间" @change="sfomartData1">
              </el-date-picker>
          </el-form-item>
          <el-form-item>
      ...
      <el-col :span="24">
        <el-table :data="listData" v-loading="fullscreenLoading" element-loading-text="拼命加载中" border style="width: 120%">
          ...
          <!-- <el-table-column prop="spec" label="请假标题" min-width="300"> </el-table-column> -->
          <!-- <el-table-column prop="labSubmitProjects" label="请假原因" :formatter="stateFormat" min-width="120"> </el-table-column> -->
          <el-table-column prop="product" label="请假类别" ></el-table-column>
          <el-table-column prop="beginDate" label="请假开始时间" :formatter="stateFormat1"></el-table-column>
          <el-table-column prop="endDate" label="请假结束时间" :formatter="stateFormat1"></el-table-column>
          <el-table-column prop="days" label="请假天数" :formatter="stateFormat2"></el-table-column>
          <el-table-column prop="approveperson" label="批准人" ></el-table-column>
          <el-table-column prop="changeperson" label="工作替代人" ></el-table-column>
          <!-- <el-table-column prop="batchNumber" label="请假人职位" min-width="300"></el-table-column> -->
...
<script>
import { readLeaveList , deleteReward , updataReward } from "@/api/hr"
...
export default {
  ...
  methods: {
    ...
    sfomartData(va , a) {
      this.search.beginDate = va;
    },
    sfomartData1(va) {
      this.search.endDate = va;
    },
    ...
    stateFormat2(row, column) {
      let state = row;
      console.log(state)
      return row.days + row.hours + row.minus
    ...
    readData() {
      ...
      readLeaveList(this.search).then(response => {
