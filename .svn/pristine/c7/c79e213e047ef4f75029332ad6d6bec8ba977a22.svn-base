    ...
    <el-row>
      ...
      <el-col :span="24">
        ...
        <el-table :data="listData" v-loading="fullscreenLoading" element-loading-text="拼命加载中" border style="width: 120%">
          ...
          <el-table-column prop="school" label="学校" min-width="300"></el-table-column>
  
          <el-table-column prop="major" label="专业" min-width="300"></el-table-column>
  
          <el-table-column prop="degree" label="学位" min-width="300"></el-table-column>
  
          <el-table-column prop="degreeNumber" label="学位证号" min-width="300"></el-table-column>
  
          <el-table-column prop="educational" label="学历" min-width="300"></el-table-column>
  
          <el-table-column prop="educationalNumber" label="学历证号" min-width="300"></el-table-column>
  
          <el-table-column prop="foster" label="培养方式" min-width="300"></el-table-column>
  
          <el-table-column prop="xz" label="学制" min-width="300"></el-table-column>
  
          <el-table-column prop="wy" label="外语" min-width="300"></el-table-column>
  
          <el-table-column prop="wycj" label="外语成绩" min-width="300"></el-table-column>
  
          <el-table-column prop="ifHeighXw" label="是否最高学位" min-width="150" :formatter="stateFormat"></el-table-column>
  
          <el-table-column prop="ifHeighXl" label="是否最高学历" min-width="150" :formatter="stateFormat"></el-table-column>
    ...
    <el-dialog title="奖励" :visible.sync="detailIO">
      <table class="table tableOcc">
        ...
        <tr>
          ...
          <td>培养方式 : </td>
          <td>
            <el-input v-model="form.foster"></el-input>
          </td>
        </tr>
        <tr>
          <td>开始日期 : </td>
        ...
        <tr>
          ...
          <td>学制 : </td>
          <td style="text-align:left">
            <el-input v-model="form.xz"></el-input>
          </td>
        </tr>
        <tr>
          <td>学位 : </td>
          ...
          <td>学位证号 : </td>
          <td style="text-align:left">
            <el-input v-model="form.degreeNumber"></el-input>
          </td>
        </tr>
        <tr>
          <td>学历 : </td>
          <td>
            <el-input v-model="form.educational"></el-input>
          </td>
          <td>学历证号 : </td>
          <td style="text-align:left">
            <el-input v-model="form.educationalNumber"></el-input>
          </td>
        </tr>
        <tr>
          <td>外语 : </td>
          ...
          <td>外语成绩 : </td>
          <td style="text-align:left">
            <el-input v-model="form.wycj"></el-input>
          </td>
        </tr>
        <tr>
          <td>是否最高学位 : </td>
          <td style="text-align:left">
            <el-switch v-model="form.ifHeighXw" on-text="" off-text="" on-value="0" off-value="1">
            </el-switch>
          </td>
          <td>是否最高学历 : </td>
          <td style="text-align:left">
            <el-switch v-model="form.ifHeighXl" on-text="" off-text="" on-value="0" off-value="1">
            </el-switch>
          </td>
        </tr>
        <tr>
...
<script>
  import {
    ...
    readStudyexperienceList,
  
    deleteStudyexperience,
  
    updataStudyexperience
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        ...
        updataStudyexperience(this.form).then(res => {
      ...
      readData() {
        ...
        readStudyexperienceList(this.search).then(response => {
