        ...
        <div class="wrap effect box-center">
            ...
            <el-form ref="form" :model="form" label-width="80px">
                ...
                <el-form-item>
                    ...
                    <el-button v-if="this.snew != 1" type="default" :plain="true" @click.stop.prevent="goBack()">取消</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
...
export default {
            ...
            this.$confirm('确定要发布吗?', '提示', {
                ...
                updataAnnouncement(this.form).then(res => {
                    if (res.httpCode == 200) {
                        ...
                        this.$router.push({path: '/OA/announcement/myAnnouncement'});
                    } else {
                        this.$message({
                            type: 'info',
                            message: '操作失败'
    ...
    mounted() {
        ...
        if(this.sdata){
            this.sdata.allowRange = this.sdata.allowRange.replace(/#/g,"");
            if(this.sdata.allowRange != 0){
                this.announceDept = this.sdata.allowRange.split(',')
                this.sdata.allowRange = '1'
            }
            console.log(this.announceDept)
            this.form=this.sdata;
            console.log(this.form)
        }
